...
![Docker - callum027/buildarr](https://img.shields.io/docker/v/callum027/buildarr?label=callum027%2Fbuildarr) ![GitHub - buildarr-installer](https://img.shields.io/github/v/release/buildarr/buildarr-installer?label=buildarr-installer) ![GitHub License](https://img.shields.io/github/license/buildarr/buildarr)
<br>
![PyPI - buildarr](https://img.shields.io/pypi/v/buildarr?label=buildarr) ![PyPI - buildarr-sonarr](https://img.shields.io/pypi/v/buildarr-sonarr?label=buildarr-sonarr) ![PyPI - buildarr-radarr](https://img.shields.io/pypi/v/buildarr-radarr?label=buildarr-radarr) ![PyPI - buildarr-prowlarr](https://img.shields.io/pypi/v/buildarr-prowlarr?label=buildarr-prowlarr) ![PyPI - buildarr-jellyseerr](https://img.shields.io/pypi/v/buildarr-jellyseerr?label=buildarr-jellyseerr)
